...
class Test_score():
	...
	def test_calculate_correct_winner_partial_result(self):
		user_score = calculate_user_score('Brasil', 'Brasil', 2, 2, 1, 0)
		assert(user_score == 6)

	def test_calculate_correct_winner_wrong_result(self):
		user_score = calculate_user_score('Brasil', 'Brasil', 3, 2, 1, 0)
		assert(user_score == 3)

	def test_calculate_wrong_winner_partial_result(self):
		user_score = calculate_user_score('Brasil', 'Argentina', 3, 3, 1, 4)
		assert(user_score == 1)

	def test_calculate_wrong_bet(self):
		user_score = calculate_user_score('Argentina', 'Brasil', 3, 2, 1, 0)
		assert(user_score == 0)

	def test_user_score_after_first_bet(self):
	...
	def test_user_score_after_multiple_bets(self):
	...
	def test_score_after_terrible_sequence_bets(self):
	...
	def test_score_after_perfect_sequence_bets(self):
